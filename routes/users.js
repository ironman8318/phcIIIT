...
// Get Register Page
//so that random user cant access
...
router.get("/patientRegister",ensureAuthenticated,(req,res,next) => {
...
router.post('/addusertypes/:id',ensureAuthenticated,(req,res,next)=>{
	var usertype = req.body.usertype;
	var id= req.params.id;
	User.findByIdAndUpdate( id,{ $set: { usertype : usertype }},(err,user)=>{
	        	if(err) return err;
	        	console.log("registerd successfully as" + usertype);
	        	res.redirect("/usertype");
			})
