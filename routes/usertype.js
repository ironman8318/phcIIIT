...
router.get('/', ensureAuthenticated, function(req, res, next) {
    ...
    if(req.user.usertype==="Faculty" || req.user.usertype==="ResearchStaff" || req.user.usertype==="OfficeStaff" ||req.user.usertype==="ProjectStaff" || req.user.usertype==="Faculty" || req.user.usertype==="Staff"   ){
        var str = req.user.email;
        var str2 = req.user.usertype;
        var patt = /@iiitdmj.ac.in/i;
        if (str.match(patt)) {
