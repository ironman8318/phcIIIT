...
mongoose.connect('mongodb://localhost:27017/phc', { useNewUrlParser: true }, function(err, db) {
    ...
    client.on('connection', function(socket) {
        ...
        var dataa;
          ...
          socket.on("inOffice",function(data){
            client.emit("inOffice1",data);
            console.log(data);
        ...
        socket.on('input', function(data) {
            ...
            if (data.diseaseDescription == "")
                diseaseDescription = "Not Mentioned";
            else
                    ...
                    nodemailer.createTestAccount((err, account) => {
                        ...
                        var mailOptions = {
                            ...
                            html: '<div style="margin-right:-15px;margin-left:-15px;">' +
                                ...
                                '<li style="position:relative;display:block;padding:10px 15px;margin-bottom:-1px;background-color:#fff;border:1px solid #AEB6BF"><b>Relative Of. :  </b>' + relatedto + '</li>' +
                                '<li style="position:relative;display:block;padding:10px 15px;margin-bottom:-1px;background-color:#fff;border:1px solid #AEB6BF"><b>Relation :  </b>' + relation + '</li>' +
